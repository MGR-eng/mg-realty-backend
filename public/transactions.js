...
function openNewTx(stage) {
  ...
  ['tx-address','tx-price','tx-commission','tx-closingdate','tx-offer-date','tx-inspection-date','tx-contingency-date','tx-loan-date','tx-coop-agent','tx-coop-brokerage','tx-notes'].forEach(function(id) {
...
function openEditTx(id) {
  ...
  var fmap = {'tx-address':d.address,'tx-price':d.salePrice,'tx-commission':d.commissionPct,'tx-closingdate':d.closeDate,'tx-offer-date':d.offerDate,'tx-inspection-date':d.inspectionDeadline,'tx-contingency-date':d.contingencyRemoval,'tx-loan-date':d.loanApprovalDeadline,'tx-coop-agent':d.coopAgent,'tx-coop-brokerage':d.coopBrokerage,'tx-notes':d.notes};
